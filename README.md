...
```
2. Add the required classes `sand-carousel` and `slides-wrapper` to the containing elements and `slide` class to the carousel's items in a markup similar to the one below.
